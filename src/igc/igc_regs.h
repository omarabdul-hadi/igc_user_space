...
// rx ring params, 4 at 0x40 each, but remove we are only using one ring, i.e one queue
#define IGC_SRRCTL		0x0C00C
#define IGC_RDBAL		0x0C000   // DMA Base address low
#define IGC_RDBAH		0x0C004   // DMA Base address hig
#define IGC_RDLEN		0x0C008
#define IGC_RDH		    0x0C010   // Rx data head
#define IGC_RDT		    0x0C018   // Rx data tail
#define IGC_RXDCTL		0x0C028
...
#define IGC_RAL(_n)		(0x05400 + ((_n) * 0x08)) /* Receive address low  (i.e MAC address) */
#define IGC_RAH(_n)		(0x05404 + ((_n) * 0x08)) /* Receive address high (i.e MAC address) */
...
// tx ring params, 4 at 0x40 each, but remove we are only using one ring, i.e one queue
#define IGC_TDBAL		0x0E000  // DMA Base address low
#define IGC_TDBAH	    0x0E004  // DMA Base address high
#define IGC_TDLEN   	0x0E008
#define IGC_TDH 	    0x0E010  // Tx data head
#define IGC_TDT		    0x0E018  // Tx data tail
#define IGC_TXDCTL		0x0E028
