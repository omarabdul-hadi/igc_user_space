 ...
 */
static int32_t igc_phy_setup_autoneg(struct igc_hw *hw)
{
	struct igc_phy_info *phy = &hw->phy;
 ...
 */
static int32_t igc_wait_autoneg(struct igc_hw *hw)
{
	uint16_t i, phy_status;
	int32_t ret_val = 0;
 ...
 */
static int32_t igc_copper_link_autoneg(struct igc_hw *hw)
{
	struct igc_phy_info *phy = &hw->phy;
	uint16_t phy_ctrl;
	int32_t ret_val;
 ...
 */
static int32_t igc_read_phy_reg_mdic(struct igc_hw *hw, uint32_t offset, uint16_t *data)
{
	struct igc_phy_info *phy = &hw->phy;
	uint32_t i, mdic = 0;
	int32_t ret_val = 0;
 ...
 */
static int32_t igc_write_phy_reg_mdic(struct igc_hw *hw, uint32_t offset, uint16_t data)
{
	struct igc_phy_info *phy = &hw->phy;
	uint32_t i, mdic = 0;
	int32_t ret_val = 0;
 ...
 */
static int32_t __igc_access_xmdio_reg(struct igc_hw *hw, uint16_t address,
				  uint8_t dev_addr, uint16_t *data, bool read)
{
	int32_t ret_val;
 ...
 */
static int32_t igc_read_xmdio_reg(struct igc_hw *hw, uint16_t addr,
			      uint8_t dev_addr, uint16_t *data)
{
 ...
 */
static int32_t igc_write_xmdio_reg(struct igc_hw *hw, uint16_t addr,
			       uint8_t dev_addr, uint16_t data)
{
